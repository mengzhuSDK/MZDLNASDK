package tv.mengzhu.dlna.manager;
...
import tv.mengzhu.dlna.VApplication;
import tv.mengzhu.dlna.callback.ContentBrowseCallback;
import tv.mengzhu.dlna.entity.RemoteItem;
import tv.mengzhu.dlna.event.DIDLEvent;
import tv.mengzhu.dlna.listener.ClingRegistryListener;
import tv.mengzhu.dlna.service.ClingService;
import tv.mengzhu.dlna.service.SystemService;
import tv.mengzhu.dlna.utils.LogUtils;
...
public class ClingManager {
    ...
    private void unbindService() {
        if (getRegistry() != null) {
            getRegistry().removeListener(clingRegistryListener);
        }
